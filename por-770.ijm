...
n_x_slices=5;
cut_scalebar=150; 
path="C:\\Users\\salmasi\\Google Drive\\MyPhD\\Projects\\experimental\\LPM\\770-961";
headfolders=newArray("\\samp1","\\samp5","\\samp4","\\samp6");

path="C:\\Users\\salmasi\\Google Drive\\MyPhD\\Projects\\experimental\\LPM\\770-961";
headfolders=newArray("\\samp1","\\samp6","\\samp5","\\samp4");
for (headfolder= 0; headfolder <headfolders.length; headfolder++) {
	root=path+headfolders[headfolder];
	folders=newArray("250-","750-","1250-","1750-","2250-","2750-","3250-","3750-");
	outputfolder=root+"\\"+"770-por";
	file_type=".tif";
	th_1=0;
	th_2=50;
	n_y_slices=6;
...
//________________________________________loop over images
